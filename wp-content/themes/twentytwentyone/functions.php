...
wp_enqueue_script('jquery-main', get_template_directory_uri().'/assets/js/jquery-3.6.0.min.js');

function save_update_data(){

	if(isset($_REQUEST['field']) OR isset($_REQUEST['value']) OR isset($_REQUEST['id'])){
		$field = ($_REQUEST['field']);
		$value = ($_REQUEST['value']);
		$editid = ($_REQUEST['id']);
	
		global $wpdb;
    	$results = $wpdb->get_results("UPDATE test_table SET ".$field."='".$value."' WHERE id=".$editid);	
...
add_action('wp_ajax_save_update_data','save_update_data');
add_action('wp_ajax_nopriv_save_update_data','save_update_data');
?>
